jQuery(document).ready(function() {
  ...
  $.i18n().load({
    ...
    'fi': {
      ...
      'text-about-p5': 'Menin myös naimisiin ja etsiessäni sopivaa hääkuvaajaa tulin ensimmäistä kertaa ajatelleeksi, että on olemassa sellainenkin ammatti kuin perhevalokuvaaja. Inspiroiduin ja kuvasin muutamat nimiäiset  ja häät. Tämän jälkeen olin aivan myyty ja tiesin haluavani kehittyä  valokuvaajana. Syksyllä 2017 aloitin medianomin opinnot Haaga-Helian ammattikorkeakoulussa, jossa olen opiskellut muun muassa valokuvauksellista ilmaisua.',
