jQuery(document).ready(function() {
  ...
  $.i18n().load({
    ...
    'fi': {
      ...
      'text-about-p2': 'Valokuvaus on ollut iso osa elämääni jo pienestä pitäen, sillä isäni harrasti intohimoisesti valokuvausta jo ollessani pieni. Hänen tekemänsä kuva-albumit ovat auttaneet minua muistamaan asioita lapsuudestani ja monesta kuvasta on tullut minulle erittäin tärkeä.',
      ...
      'text-about-p4': 'Kesällä 2017 elämäni oli eräänlaisessa taitekohdassa. Valmistuin yliopistosta, mutta koin, etten ollut valmis siirtymään kaksin jaloin työelämään. Halusin tehdä työkseni jotain luovempaa, kuin mitä omalta alaltani valmistuneet tyypillisesti tekevät. Urahaaveissani olikin eräänlainen musta aukko.',
      'text-about-p4': 'Syksyllä 2017 aloitin medianomin opinnot Helsingin avoimessa ammattikorkeakoulussa, jossa olen opiskellut muun muassa valokuvauksellista ilmaisua.',
      'text-about-p5': 'Pyrin valokuvauksessa luonnollisuuteen. Tyylissäni voi havaita rosoisuutta ja historian havinaa. Rakkauteni luontoon ja eläimiin on myös jättänyt jälkensä kuvakerrontaani.',
