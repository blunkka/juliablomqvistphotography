jQuery(document).ready(function() {
  ...
  $.i18n().load({
    ...
    'fi': {
      ...
      'text-about-p2': 'Valokuvaus on ollut aina läsnä elämässäni, sillä isäni harrasti intohimoisesti valokuvausta jo ollessani pieni. Hänen tekemänsä kuva-albumit ovat auttaneet minua muistamaan asioita lapsuudestani ja monesta kuvasta on tullut minulle erittäin tärkeä.',
