jQuery(document).ready(function() {
  ...
  $.i18n().load({
    'en': {
      ...
      'header-intro': 'Nice that you are here!',
      'text-intro': 'I’m Julia Blomqvist, a 30-year old family photographer from Helsinki. I strongly believe that every individual, relationship and moment is unique and beautiful in it’s own special way. I feel that I have succeeded as a photographer when I manage to capture this beauty so that the outcome is as natural as possible. This means I don’t aim to take shoots that look like ads. Instead my goal is to create images from which you can easily recognize the best qualities of yourself and your loved ones. Pictures that help you to remember moments and relationships those lie close to your heart. I shoot mainly in the metropoly area of Helsinki, but I can be hired to photograph everywhere in Finland. In addition to Finnish I can serve my customers in English and German. If you got interested, contact me via the contact form and I will reply within 24 hours. I can’t wait to hear from you and plan a photo shoot that serves your needs in the best possible way.',
      ...
      'text-about-p2': 'Photography has been a part of my every day life already as a child. It’s because my father used to photograph a lot when I was young and he still does. Pictures taken by him have helped me to remember things from way back then and many of the images have become very important to me.',
      'text-about-p3': 'I personally got excited about photography when I got my first system camera in 2012. I instantly started to shoot at home and on holidays, but I didn’t see photography as something I would like to do for work yet.',
      ...
      'text-about-p5': 'That summer I also got married. While searching for my own wedding photographer I came to think of for the first time that people actually photograph ”regular” people outside the studio for work. I felt inspired and photographed a few weddings and child naming ceremonies. After those experiences I knew photography was something in which I would love to develop my skills.',
      'text-about-p6': 'My aim as a photographer can be squeezed to one word: naturalness. I don’t do heavy editing and I strive to find the natural beauty of each individual I photograph.',
      ...
      'text-about-p8': 'I’m very open to different kind of projects so don’t be afraid to suggest ”crazy” or ”unusual” photography ideas to me. My ultimate goal is to take pictures that give you joy for the rest of your life.',
      ...
      'text-contact-p1': 'I’m very happy, if you have decided after seeing my webpage that you want to get to know me better and let me capture something that is important for you.',
      ...
      'text-photopackages-p1': 'My charging is based on the time I put to the photography session, not to how many pictures the customer receives. However I do promise <b>a minimum amount of carefully edited images</b> for each hour I shoot. The time and price of the session are always agreed with the customer in beforehand. <b>I promise to deliver the pictures digitally within two weeks</b>. I’m a beginner in professional photography, which has been taken into account in my fee. <b>I always charge via Ukko.fi</b>, which makes sure, that the taxes are being paid correctly from my photography pay.',
      'text-photopackages-p2': '<b>I charge 90 euros for one hour and 45 euros accordingly for half an hour</b>. For <b>one hour photography session I promise at least 20 edited images</b> and <b>from half an hour 3 images</b>. With these prices I’m allowed to use the pictures for marketing my photography services online etc. You can also share the pictures on Facebook and on other platforms if you wish as long as the photographer is being mentioned.',
      'text-photopackages-p3': 'I have noticed that sometimes people find a photography session and images of themselves or their children very intimate and are therefore uncomfortable by the idea that the pictures are showed in public for instance on my website. I want to be able to serve these customers as well. Therefore <b>I also offer a contract where both of the sides agree not to publish the images online</b> or anywhere else <b>in public</b>. In this case <b>I charge fifty per cent extra from the service</b>, which means that my fee for one hour is <b>135 euros</b> and half an hour accordingly <b>67,5 euros</b>. However you can share the photos in social media to a limited group of people if you like, in which case the photographer must be mentioned as well.',
      'text-photopackages-p4':'From a photography session over 10 kilometers away from my home in Herttoniemi, <b>I charge a kilometer allowance, which is 0,5 euros per kilometer</b>. From <b>a photography session over three hours I charge 20 per cent</b> of the fee <b>in beforehand</b>.',
      'text-photopackages-p5': 'I do also sell <b>handmade gift cards</b> to the different photography services. What would be a better gift to somebody you love than a series of pictures of you together in a setting that represents your relationship?',
      'text-photopackages-p6': 'Did you get interested? Contact me via the <a href="contact.html">contact form</a> and let’s go for a coffee to chat. We can discuss your hopes and plan a photo shoot session that serves your needs as well as possible.',
      'dl-photopackages-header':'I recommend following amounts of time for the different photography sessions, although the time needed always depends of what kind of photos the client wishes to receive',
